...
export const SETTINGS_ITEMS: SettingsItem[] = [
	...
	// Voice
	{
		id: SETTING_ITEM_ID.VOICE_ENABLED,
		section: "voice",
		title: "Voice Control",
	...
	{
		id: SETTING_ITEM_ID.VOICE_TTS,
		section: "voice",
		title: "Text-to-Speech Provider",
		description: "Choose between ElevenLabs or macOS built-in speech",
		keywords: [
			"voice",
			"tts",
			"text to speech",
	...
	{
		id: SETTING_ITEM_ID.VOICE_TRACE,
		section: "voice",
		title: "Tool-Trace Cache",
		description: "Cache repeated voice commands for faster execution",
		keywords: [
			"voice",
			"trace",
			"cache",
